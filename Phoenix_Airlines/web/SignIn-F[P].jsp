<%-- 
    Document   : SignIn
    Created on : Oct 5, 2022, 7:39:02 PM
    Author     : USER
--%>
...
<html>
	...
	<body>
		...
		<br>
	<div class="NU">
		<form class="center_form" action="LoginFormHandle.jsp" method="POST" id="new_user_from">
			<h2><i class="fa fa-user-plus" aria-hidden="true"></i> CREATE NEW USER ACCOUNT</h2>
			<br>

		<div class="ELD">

			<div class="title"><strong>ENTER LOGIN DETAILS</strong></div>
		...
		<div class="ECPD">
			...
			<div class="title1"><strong>ENTER CUSTOMER'S PERSONAL DETAILS</strong></div>
