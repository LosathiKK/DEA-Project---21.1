...
<html>
	...
	<body class="Lbody">
		...
		<br>
		<br>
		<form class="float_form" style="padding-left: 40px" action="LoginFormhandle.jsp" method="POST">
			<fieldset>
				<legend>Login Details:-</legend>
				<strong>@E-Mail</strong><br>
				<input type="text" name="L_email" placeholder="Enter your E-Mail" required><br><br>
