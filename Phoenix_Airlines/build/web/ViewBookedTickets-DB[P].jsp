<%-- 
    ...
    Created on : Oct 3, 2022, 11:42:55 PM
    Author     : USER
--%>
	...
	<body>
		...
		<div>
			<ul>
				...
				<li><a href="logIn-F[P]"><i class="fa fa-desktop" aria-hidden="true"></i> Dashboard</a></li>
				<li><a href="About Us.html"><i class="fa fa-plane" aria-hidden="true"></i> About Us</a></li>
